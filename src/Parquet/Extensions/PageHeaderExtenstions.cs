...
namespace Parquet.Extensions {
    internal static class PageHeaderExtenstions {
        ...
        public static void SetStatistics(this Thrift.PageHeader ph, Statistics statistics) {
            if(ph.Type == PageType.DATA_PAGE)
                ph.Data_page_header.Statistics = statistics;
            else
                ph.Data_page_header_v2.Statistics = statistics;
        }
